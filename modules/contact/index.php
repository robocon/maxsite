                                ...
                                <TD>
                                    <BR>
                                        ...
                                        if( isset($_GET['action']) && $_GET['action'] == "sendmail" ){
                                            ...
                                            if( !preg_match('/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,})$/',$_POST['YOURMAIL'])){
                                            ...
                                            <FORM METHOD=POST ACTION="?name=contact&action=sendmail">
                                                <TABLE width="80%" align="center">
                                                    <TR>
                                                        ...
                                                        <TD><INPUT TYPE="text" NAME="SUBJECT" size="40" value="<?=( isset($_POST['SUBJECT']) ? $_POST['SUBJECT'] : '' );?>"></TD>
                                                        </TR>
                                                        <TR>
                                                            <TD align="right"><B>อีเมล์ของท่าน : </B></TD>
                                                            <TD><INPUT TYPE="text" NAME="YOURMAIL" size="40" value="<?=( isset($_POST['YOURMAIL']) ? $_POST['YOURMAIL'] : '' );?>"></TD>
                                                            </TR>
                                                            <TR>
                                                                <TD align="right" valign="top"><B>ข้อความ : </B></TD>
                                                                <TD><TEXTAREA NAME="DETAIL" ROWS="5" COLS="40"><?=( isset($_POST['DETAIL']) ? $_POST['DETAIL'] : '' );?></TEXTAREA></TD>
                                                            </TR>
                                                            <?php
                                                            if(USE_CAPCHA){
                                                                ?>
