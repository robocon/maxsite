...
?>
				<TR>
					<TD>
					<B><FONT COLOR="#990000"><?=$arr[category][category_name];?><BR><?=$arr[news][topic];?></FONT></B><BR>
...
?>
			...
			<TR>
				...
				<?php if($_SESSION['admin_user']){echo " <A HREF=\"?name=news&file=delete_comment&id=".$_GET[id]."&comment=".$arr[comment][id]."\"><IMG SRC=\"images/admin/trash.gif\" WIDTH=\"20\" HEIGHT=\"20\" BORDER=\"0\" ALIGN=\"absmiddle\"></A>";};?>
