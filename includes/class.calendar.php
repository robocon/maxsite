<?php //หากมีการเรียกไฟล์นี้โดยตรง
    	...
    	while ($d <= $daysInMonth)
    	{
    	    ...
    	    for ($i = 0; $i < 7; $i++)
    	    {
    	        ...
    	        if ($d > 0 && $d <= $daysInMonth)
    	        {
    	            ...
    	            //Date link here
					$s .= (($link == "") ? $d : "<a href=\"".$link['link']."\" onclick=\"return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe', objectWidth: 700, objectHeight: 500} )\" class=\"highslide\" onMouseover='ddrivetip(\"".$link['title']."\",\"\", 250)'; onMouseout='hideddrivetip()'><IMG SRC=\"images/icon/pencil_icon.gif\" BORDER=\"0\" ALIGN=\"\"> <B>$d</B></a>");
    	        }
    	        else
    	        {
    	            $s .= "&nbsp;";
