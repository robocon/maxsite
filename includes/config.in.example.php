...
define("_MNAME",( isset($_GET['name']) ? $_GET['name'] : 'index' ));
define("_MFILE",( isset($_GET['file']) ? $_GET['file'] : 'index' ));

//ตรวจสอบ IP
if ( isset($_SERVER['HTTP_CLIENT_IP']) ) {
    $IPADDRESS = $_SERVER['HTTP_CLIENT_IP'];
} elseif ( isset($_SERVER["HTTP_X_FORWARDED_FOR"]) && preg_match("/[0-9]/", $_SERVER["HTTP_X_FORWARDED_FOR"]) ) {
